				...
				<div class="row w-100 ">
					<div class="col-4 mr-auto">
						<a class="navbar-brand" href="home.php">
							<img class="d-inline-block" src="assets/logo.png" width="30" height="30" alt="Logo" loading="lazy"><span class="ml-2">Online Shop</span>
						</a>
					</div>
					<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navOptions" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
					...
					<div class="collapse navbar-collapse" id="navOptions">
						...
						<div class="col d-flex justify-content-end" style="margin-right: -2rem">
							<?php
								if(!isset($_SESSION['uidUser'])){
									...
									echo "	<span class=\"d-flex align-items-center text-light\">Welcome ".$_SESSION['uidUser']."!</span>
